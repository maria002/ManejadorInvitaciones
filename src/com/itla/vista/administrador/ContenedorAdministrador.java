 ...
 * @author Maria Elena
 */
public class ContenedorAdministrador extends javax.swing.JFrame {

    private JFrame padre;
    /**
     * Creates new form ContenedorPrincipal
     */
    public ContenedorAdministrador() {
        initComponents();
    }
    
    public ContenedorAdministrador(JFrame padre){
        this();
        this.padre = padre;
    }
    ...
    public void abrirVentana(AbstractPanel panel, String titulo) {
        ...
        try {
            ...
            Logger.getLogger(ContenedorAdministrador.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContenedorAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContenedorAdministrador().setVisible(true);
            }
        });
    }
